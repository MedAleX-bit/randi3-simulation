...
////
////    val actTrial = Trial(Int.MinValue, 0, "trial", "trial", "Description", new LocalDate(2012, 6, 1), new LocalDate(2014, 6, 1), StratifiedTrialSite.NO, TrialStatus.ACTIVE, treatments, criterions, List(site), Some(algorithm), stages, TrialSubjectIdentificationCreationType.CONTINUOUS_COUNTER).toOption.get
////
////    actTrial
////  }
////
...
//////    val simTrials = SimulationUtil.simulate1(new Simulation1, 1, new MersenneTwister())
//////
